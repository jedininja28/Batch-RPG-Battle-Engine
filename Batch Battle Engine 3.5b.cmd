...
:RESTART
SET /A STR=8 + (%Random%/5000)
SET /A DEX=8 + (%Random%/5000)
SET /A INT=8 + (%Random%/5000)
...
SET /A Divisor=16383
SET /A ZO=%R0%/"%Divisor%"
REM IF /I %ZO% EQU 1 (GOTO TURN1) ELSE (GOTO TURN2) 
...
ECHO  Dice1: %Dice% Dice2: %Dice2% 
ECHO  HitChance: %HitChance% DefenceChance: %DefenceChance%
ECHO ===============================================
ECHO ===============================================
ECHO                 MONSTER ROLL!
ECHO ===============================================
...
SET /A mHitChance=(%mDEX%*%mDice%)+%mStamina%-20
SET /A mDefenceChance=(%mDEX%*%mDice2%)+%mStamina%-20

ECHO  Dice1: %mDice% Dice2: %mDice2%
ECHO  HitChance: %mHitChance% DefenceChance: %mDefenceChance%
                                  JU8JUMNH
ECHO ===============================================
...
:MonsterDamageStep
SET /A mAttack=%mAttack%+(%Random%/4500) + (%mSTR%/4)
SET /A mDamage=%mAttack%-%Defence%
...
ECHO ===============================================   
IF /I %mHitPoints% LEQ 0 (GOTO Win) ELSE IF /I %HitPoints% LEQ 0 (GOTO Lose)         
PAUSE>NUL
GOTO TURN2

:TURN2
:Roll
REM SET /A Dice=(%Random%/5461)
REM SET /A Dice2=(%Random%/5461)
REM SET /A HitChance=(%DEX%*%Dice%)+%Stamina%
REM SET /A DefenceChance=(%DEX%*%Dice2%)+%Stamina%

REM SET /A mDice=(%Random%/5461)
REM SET /A mDice2=(%Random%/5461)
REM SET /A mHitChance=(%mDEX%*%mDice%)+%mStamina%-20
REM SET /A mDefenceChance=(%mDEX%*%mDice2%)+%mStamina%-20

REM SET /A Experience=%Experience%
REM SET /A LevelModifyer=%LevelModifyer%
REM SET /A Level=%Level%

:PlayerDamageStep
SET /A Attack=%Attack%+(%Random%/4500) + (%STR%/4)
SET /A Damage=%Attack%-%mDefence%
