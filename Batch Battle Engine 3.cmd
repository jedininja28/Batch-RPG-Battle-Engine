...
::Import Monster, Weapons and Battle Messages for seperate file
::MAKE ITEMS / ARMOR
...
:START
REM SET /A Weapon=%Weapon%
REM SET /A Armor=%Armor%
REM SET /A Energy=%Energy%

REM SET /A mWeapon=%mWeapon%
REM SET /A mArmor=%mArmor%
REM SET /A mEnergy=%mEnergy%
:TURN 1
...
ECHO.                    
ECHO ===============================================
ECHO  STR:%STR%     Life:%HitPoints%     Wep:%Weapon% 
ECHO  DEX:%DEX%   Energy:%Energy%     Arm:%Armor%
ECHO  INT:%INT%  Stamina:%Stamina%       %Kill%/%Death%
ECHO ===============================================
...
IF /I %mEnergy% GTR 40 SET /A mEnergy=%mEnergy%-2
...
:SpaceLaser
IF /I %Energy% LSS 50 goto NeedMoreEnergy
SET /A Armor=0
